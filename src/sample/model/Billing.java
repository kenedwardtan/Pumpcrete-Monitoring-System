...
//    public SimpleStringProperty received_by;
    ...
    public Billing(int client_id, String project_name, String project_add){
                  // int PSC_id, String concrete_struct, int floor, float quantity,
                   //float unit_price, float total, float grand_total, boolean posted, String checked_by, String approved_by, String posted_by,String received_by, int id) {
        //this.id = new SimpleIntegerProperty(id);
       // this.date_doc =new Date(date_doc);
        ...
        //this.date_used = new Date(date_used);
...
//    public Billing(int client_id, String project_name, String project_add, Date date_used,
//                   int PSC_id, String concrete_struct, int floor, float quantity,
//                   float unit_price, float total, float grand_total, boolean posted,
//                   String checked_by, String approved_by, String posted_by, String received_by, int id, Date date_doc){
//        this.id = new SimpleIntegerProperty(id);
